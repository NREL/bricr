...
class CreateTypicalBuildingFromModelBRICR_Test < MiniTest::Unit::TestCase
  ...
  def apply_measure_to_model(test_name, args, model_name = nil, result_value = 'Success', warnings_count = 0, info_count = nil)
    ...
    measure = CreateTypicalBuildingFromModelBRICR.new
  ...
  def test_large_hotel_restaurant
    args = {}
    #args["space_name"] = "New Space"
    # using defaults values from measure.rb for other arguments

    apply_measure_to_model(__method__.to_s.gsub('test_',''), args, 'large_hotel_restaurant_multiplier_test_output.osm',nil,nil)
  end
  ...
  def test_blended_space_types
    args = {}
    args["add_constructions"] = false
    args["add_space_type_loads"] = false
    args["add_elevators"] = false
    args["add_exhaust"] = false
    args["add_exterior_lights"] = false
    args["add_swh"] = false
    args["remove_objects"] = true
    args["add_thermostats"] = true
    args["add_hvac"] = true

    apply_measure_to_model(__method__.to_s.gsub('test_',''), args, 'mixed_hotel_rest_by_story_test_output.osm',nil,nil)
  end
