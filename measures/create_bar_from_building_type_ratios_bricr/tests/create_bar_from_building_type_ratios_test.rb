...
class CreateBarFromBuildingTypeRatiosBRICR_Test < Minitest::Test
  ...
  def apply_measure_to_model(test_name, args, model_name = nil, result_value = 'Success', warnings_count = 0, info_count = nil)
    ...
    measure = CreateBarFromBuildingTypeRatiosBRICR.new
  ...
  def test_good_argument_values_bricr
    args = {}
    args['total_bldg_floor_area'] = 10000.0
    args['template'] = 'CBES T24 2008'
