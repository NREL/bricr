...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Ruby Client for communicating with SEED API}
  spec.description   = %q{Ruby Client for communicating with SEED API}
  ...
  spec.add_runtime_dependency "rest-client", "~> 2.0s"
